...
```
opp/
├── opp-parent/              # 父 POM，统一定义依赖版本和插件配置
├── opp-gateway/             # 网关服务（Spring Cloud Gateway）
├── opp-common/              # 公共模块
│   ├── opp-base-common/     # 基础公共类
│   └── opp-base-log/        # 日志模块
├── opp-api/                 # API 接口定义模块（Feign 客户端接口）
│   ├── opp-learn-api/       # 学习服务 API
│   ├── opp-user-api/        # 用户服务 API
│   ├── opp-order-api/       # 订单服务 API
│   ├── opp-meeting-api/     # 会议服务 API
│   ├── opp-test-api/        # 考试服务 API
│   ├── opp-material-api/    # 素材服务 API
│   ├── opp-basic-api/       # 基础服务 API
│   ├── opp-diy-api/         # DIY 服务 API
│   ├── opp-clock-in-api/    # 打卡服务 API
│   ├── opp-triparty-api/    # 三方服务 API
│   ├── opp-news-api/        # 资讯服务 API
│   └── opp-survey-api/      # 问卷服务 API
├── opp-learn/               # 学习服务（领域服务）
├── opp-user/                # 用户服务
├── opp-order/               # 订单服务
├── opp-meeting/             # 会议服务
...
├── opp-triparty/            # 三方服务
├── opp-task/                # 任务服务
├── opp-openapi/             # OpenAPI 服务
├── opp-survey/              # 问卷服务（基于 SurveyKing 框架）
├── opp-learn-bff/           # 学习 BFF（Backend for Frontend）
├── opp-meeting-bff/         # 会议 BFF
├── opp-news-bff/            # 资讯 BFF
├── opp-test-bff/            # 考试 BFF
├── opp-admin-bff/           # 管理后台 BFF
├── opp-wellness-bff/        #  wellness BFF
└── opp-news-websocket/      # 资讯 WebSocket 服务
```
