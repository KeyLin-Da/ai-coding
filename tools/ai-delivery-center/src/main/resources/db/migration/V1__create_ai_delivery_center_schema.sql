...
CREATE TABLE IF NOT EXISTS ad_requirement (
    ...
    current_stage VARCHAR(32) NOT NULL DEFAULT 'PRD' COMMENT '当前流程阶段：PRD、TECH_DESIGN、IMPLEMENTATION、CODE_REVIEW、RETROSPECTIVE',
...
CREATE TABLE IF NOT EXISTS ad_workflow_stage (
    ...
    stage VARCHAR(32) NOT NULL COMMENT '流程阶段：PRD、TECH_DESIGN、IMPLEMENTATION、CODE_REVIEW、RETROSPECTIVE',
...
CREATE TABLE IF NOT EXISTS ad_review (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    requirement_pk BIGINT NOT NULL COMMENT '需求主键ID，关联 ad_requirement.id',
    stage VARCHAR(32) NOT NULL COMMENT '评审所属阶段：PRD、TECH_DESIGN、IMPLEMENTATION、CODE_REVIEW、RETROSPECTIVE',
...
CREATE TABLE IF NOT EXISTS ad_artifact (
    ...
    stage VARCHAR(32) NOT NULL COMMENT '产物所属阶段：PRD、TECH_DESIGN、IMPLEMENTATION、CODE_REVIEW、RETROSPECTIVE',
...
CREATE TABLE IF NOT EXISTS ad_execution_lock (
    ...
    requirement_pk BIGINT NOT NULL COMMENT '需求主键ID，关联 ad_requirement.id',
    stage VARCHAR(32) NOT NULL COMMENT '流程阶段：PRD、TECH_DESIGN、IMPLEMENTATION、CODE_REVIEW、RETROSPECTIVE',
    action_type VARCHAR(64) NOT NULL COMMENT '人工触发动作类型，如 PRD、TECH_DESIGN、OPENSPEC_APPLY、CODE_REVIEW、RETROSPECTIVE_GENERATE',
